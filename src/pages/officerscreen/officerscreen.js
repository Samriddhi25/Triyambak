    ...
    <div className='officer'>
      <Table
        ...
        <Column width={200} align="justify" sortable>
          <HeaderCell style={{color:"black",fontSize:"medium", fontWeight:"600"}}>Officer ID</HeaderCell>
          <Cell dataKey="userId" />
        </Column>
        ...
        <Column width={150} align="justify">
          <HeaderCell style={{ color: "black", fontSize: "medium", fontWeight: "600" }}>Service Area</HeaderCell>
          <Cell dataKey="station"></Cell>
        </Column>
      </Table>
